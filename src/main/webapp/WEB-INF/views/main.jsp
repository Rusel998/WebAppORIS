...
<div class="container">
    <div class="header">
        <div class="logo-container">
            <img src="<c:url value='/images/283bd1cf5d06926aa24870c7119ad197.webp' />" alt="logo_of_the_site" class="logo_of_the_site">
            <span class="site-name">Uzel'sDating</span>
        </div>
        <ul>
            <li><a href="<c:url value='https://t.me/iblameuzel' />">Contact</a></li>
    ...
    <div class="hero">
        <div class="image">
            <img src="<c:url value='/images/DALL·E%202024-11-05%2016.36.33%20-%20A%20split-screen%20image%20showing%20a%20man%20and%20a%20woman%20using%20an%20online%20dating%20website,%20each%20on%20their%20computer.%20On%20one%20side,%20a%20man%20sits%20in%20a%20cozy%20room%20with%20war.webp' />" alt="left_centered_img" class="left_centered_img">
        </div>
        <div class="content">
            <h4>Dating is W</h4>
